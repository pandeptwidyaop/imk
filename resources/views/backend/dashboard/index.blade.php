    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Selamat Pagi</h4>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div id="carousel-example" class="carousel slide slide-bdr" data-ride="carousel" >
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="{{asset("backend/img/1.jpg")}}" alt="" />
                        </div>
                        <div class="item">
                            <img src="{{asset("backend/img/2.jpg")}}" alt="" />
                        </div>
                        <div class="item">
                            <img src="{{asset("backend/img/3.jpg")}}" alt="" />
                        </div>
                    </div>
                  ...
                  <div class="panel panel-primary ">
                        ...
                        <div class="panel-body chat-widget-main">
                            ...
                            <div class="chat-widget-name-left">
                                <img class="media-object img-circle img-left-chat" src="backend/img/user2.png" />
                                <h4>  Amanna Seiar</h4>
                           ...
                           Lorem ipsum dolor sit amet.
                            ...
                            <div class="chat-widget-name-right">
                                 <img class="media-object img-circle img-right-chat" src="backend/img/user2.png" />
                                <h4>  Amanna Seiar</h4>
                                <h5>Time 2:00 pm at 25th july</h5>
                            </div>
                            <hr />
                 ...
                 <div class="col-md-4 col-sm-4 col-xs-12">
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body text-center recent-users-sec">
                            <img class="img-thumbnail" src="backend/img/user.gif" />
                            <img class="img-thumbnail" src="backend/img/user2.png" />
                            <img class="img-thumbnail" src="backend/img/user.gif" />
                            <img class="img-thumbnail" src="backend/img/user2.png" />
                            <img class="img-thumbnail" src="backend/img/user.gif" />
                            <img class="img-thumbnail" src="backend/img/user2.png" />
             ...
             <div class="row">
                ...
                <a class="pull-left" href="#">
                  <img class="media-object img-circle img-comments" src="backend/img/user.gif" />
                </a>
                <div class="media-body">
                    ...
                    <div class="media">
                        <a class="pull-left" href="#">
                          <img class="media-object img-circle img-comments" src="backend/img/user2.png">
                        </a>
                        <div class="media-body">
